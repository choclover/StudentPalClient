...
*/
package com.studentpal.packageinstaller;
...
public class UninstallerActivity extends Activity implements OnClickListener,
    ...
    private static final String TAG = "UninstallerActivity -- HEM";
    ...
    private void startUninstallProgress() {
        ...
        //hemerr
        Toast.makeText(this, "Ready to run Uninstall process for "+mAppInfo.packageName, Toast.LENGTH_SHORT).show();
